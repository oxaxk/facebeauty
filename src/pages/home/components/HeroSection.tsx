      ...
      <div className="relative z-10 flex-1 flex items-center justify-center text-center px-6 max-w-4xl mx-auto pb-16 md:pb-8 pt-32">
        <div>
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-2xl mx-auto" style={{ fontFamily: 'Inter, sans-serif' }}>
            Lippenunterspritzung, Russian Lips & Korrekturen in Berlin. 
            Natürliche, feminine Ergebnisse durch erfahrene Ärztinnen & Heilpraktikerinnen.
          </p>
          ...
          <div className="mt-16 mb-8 md:mb-0 grid grid-cols-1 md:grid-cols-3 gap-8 text-white">
            <div className="text-center">
              ...
              <p className="text-white/80 text-sm">Spezialisierte Ärztinnen/Heilpraktikerinnen & hochwertige Filler</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white/80 text-sm">Individuelle Analyse & Lippenform-Beratung</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-white/80 text-sm">Brunnenstraße 55, Berlin-Mitte</p>
            </div>
          </div>
        </div>
      </div>
