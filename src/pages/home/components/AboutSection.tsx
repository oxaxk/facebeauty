            ...
            <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl p-6 shadow-xl max-w-xs">
              <div className="flex items-center mb-3">
                <div
                  ...
                  style={{ borderColor: '#4A331F' }}
                >
                  <i className="ri-star-fill text-xl" style={{ color: '#4A331F' }}></i>
                </div>
                <div>
                  <div className="font-bold text-lg" style={{ color: '#4A331F' }}>
                    Viele zufriedene Kundinnen
                  </div>
                  <div className="text-sm opacity-80" style={{ color: '#4A331F' }}>
                    Positive Erfahrungen & natürliche Ergebnisse
                  </div>
                </div>
              </div>
            </div>
