  ...
  const services = [
    {
      ...
      title: 'Russian Lips',
      description:
        'Spezielle Technik für volle, aber harmonische Lippen mit definierter Herzform und zarter Kontur – feminin, nicht überfüllt.',
      image: '/images/services/russian-lips.jpg'
    },
    {
      icon: 'ri-hearts-line',
      title: 'Lippenaufbau 0,5 ml',
      description:
        'Dezenter Volumen-Boost für sehr natürliche Ergebnisse – ideal für erste Korrekturen und feine Unregelmäßigkeiten.',
      image: '/images/services/lips-0-5ml.jpg'
    },
    {
      icon: 'ri-hearts-line',
      title: 'Lippenaufbau 1 ml',
      description:
        'Klar sichtbares, aber harmonisches Volumen mit Fokus auf Form, Symmetrie und eine feminine Lippenlinie.',
      image: '/images/services/lips-1ml.jpg'
    },
    {
      icon: 'ri-magic-line',
      title: 'Korrektur & Auflösung',
      description:
        'Unzufrieden mit alten Fillern? Schonende Hyaluronidase-Behandlung zur Auflösung alter oder unsauber gesetzter Hyaluron-Filler.',
      image: '/images/services/lips-correction.jpg'
    },
    {
      icon: 'ri-pencil-line',
      title: 'Kontur & Hydration (bis 2 ml)',
      description:
        'Feine Konturarbeit und Hydration für Lippen, die voller wirken, ohne unnatürlich aufzubauen – inkl. Option auf bis zu 2 ml.',
      image: '/images/services/lips-contour.jpg'
    },
    {
      icon: 'ri-graduation-cap-line',
      title: 'Lippen-Schulungen',
      description:
        'Praxisnahe Schulungen für Lippenbehandlungen, Russian Lips & Korrekturen – ideal für Behandler:innen, die ihr Skillset erweitern möchten.',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 lg:mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6" style={{ fontFamily: '"Playfair Display", serif', color: '#4A331F' }}>
            Unsere Lippenbehandlungen
          </h2>
          <p className="text-lg lg:text-xl opacity-80 max-w-3xl mx-auto" style={{ fontFamily: 'Inter, sans-serif', color: '#4A331F' }}>
            Spezialisierte Behandlungen für Lippenunterspritzung, Russian Lips & Korrekturen – natürlich, feminin und typgerecht.
          </p>
        </div>
