      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        <div className="bg-white rounded-2xl shadow-lg p-8 lg:p-12">
          ...
          <div className="prose prose-lg max-w-none" style={{ color: '#4A331F' }}>
            ...
            <div className="mb-8">
              <p className="mb-2"><strong>FACE BEAUTY BERLIN</strong></p>
              <p className="mb-2">Brunnenstraße 55</p>
              <p className="mb-2">13355 Berlin-Mitte</p>
              <p className="mb-2">Deutschland</p>
            </div>

            <h3 className="text-xl font-semibold mb-3 mt-6">Kontakt</h3>
            <div className="mb-8">
              <p className="mb-2">Telefon: +49 172 7984521</p>
              <p className="mb-2">WhatsApp: +49 172 7984521</p>
            </div>
            ...
            <div className="mb-8">
              <p className="mb-2"><strong>Berufsbezeichnung:</strong> Heilpraktikerin / Ästhetische Behandlungen</p>
