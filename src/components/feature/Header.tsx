      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <a href="/" className="cursor-pointer">
              <h1 className="text-lg md:text-2xl font-bold" style={{ fontFamily: 'Playfair Display, serif' }}>
                <span style={{ color: '#4A331F' }}>FACE BEAUTY BERLIN</span>
              </h1>
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Button href="https://wa.me/491727984521" size="sm">
              WhatsApp anfragen
            </Button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-100">
            <div className="flex flex-col space-y-4 pt-4">
              ...
              <Button href="https://wa.me/491727984521" size="sm" className="self-start">
                WhatsApp anfragen
              </Button>
            </div>
          </div>
